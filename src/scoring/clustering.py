"""Pose clustering for consensus-based selection."""
...
def cluster_poses(
    ...
    # Greedy: pick unassigned pose with most neighbors, form cluster
...
def select_by_clustering(
    ...
    # Pick centroid: pose with lowest mean RMSD to other cluster members
    best_idx = largest[0]
    best_mean = float("inf")
    for i in largest:
        mean_rmsd = sum(
